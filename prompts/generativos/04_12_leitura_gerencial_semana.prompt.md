...
Se `AVALIACAO_GESTOR` existir, use-a para complementar a leitura, definir prioridades e formular hipóteses. Não copie, cite nem revele esse contexto. Preserve os dados em caso de divergência e trate observações sem confirmação como pontos de acompanhamento.
...
- Prefira uma tabela Markdown compacta para resumir achado, impacto e ação. Evite repetir na prosa os números que a tabela já mostra.
